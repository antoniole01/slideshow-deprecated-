...
set CommonCompilerFlags= /EHsc -MTd -nologo -Gm- -GR- -EHa- -Od -Oi -WX -W4 -wd4201 -wd4100 -wd4189 -wd4456 -FC -Z7 /IC:\z\bin\SDL2-devel-2.0.4-VC\include /IC:\z\bin\SDL2_ttf-2.0.14\include /IC:\z\bin\SDL2_devel_image-2.0.1-VC\include /IC:\z\bin\glew\include /IC:\z\bin\allegro-5.0.10-msvc-10.0\include /IC:\z\bin\SFML-2.3.2\include

rem Linker Flags

set CommonLinkerFlags= -incremental:no -opt:ref user32.lib gdi32.lib winmm.lib SDL2.lib SDL2main.lib SDL2_image.lib SDL2_ttf.lib opengl32.lib glu32.lib allegro-5.0.10-monolith-md-debug.lib sfml-graphics-d.lib sfml-window-d.lib sfml-system-d.lib sfml-network-d.lib sfml-audio-d.lib openal32.lib /LIBPATH:C:\z\bin\SDL2-devel-2.0.4-VC\lib\x86 /LIBPATH:C:\z\bin\SDL2_ttf-2.0.14\lib\x86 /LIBPATH:C:\z\bin\SDL2_devel_image-2.0.1\lib\x86 /LIBPATH:C:\z\bin\SDL2_devel_image-2.0.1-VC\lib\x86 /LIBPATH:C:\z\bin\allegro-5.0.10-msvc-10.0\lib /LIBPATH:C:\z\bin\SFML-2.3.2\lib
